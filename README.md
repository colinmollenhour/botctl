...
- `dashboard` to see Claude Code panes, screen-detected Codex CLI panes, and resolvable OpenCode panes, grouped by workspace, with state, PID, CPU, memory, age, and YOLO controls for Claude and Codex
