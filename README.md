...
- offer Claude, Grok, OpenCode, Antigravity, Pi, and Codex recovery commands after an external tool recreates a missing tmux shell pane and exact matching identifies one unambiguous target; botctl stages the command but never presses Enter
