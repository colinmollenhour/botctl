...
Default install root is `~/.claude/skills/<name>/SKILL.md`. `view-skill` prints the embedded Markdown to stdout without writing files. The same skill is also available via `npx skills add colinmollenhour/botctl --skill botctl-prompt`.
