...
- `spawn_claude` (Claude spawn: required `cwd`; optional `model`, `effort`, `agent`, `permission_mode`, `settings`, `timeout_ms`, `policy`)
- `spawn_codex` (Codex spawn: required `cwd`; optional `model`, `effort`, `timeout_ms`, `policy`)
