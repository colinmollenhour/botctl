...
- shows current classified state, cook time (active work excluding idle and permission waits, persisted across dashboard restarts), wait time, branch, and workspace grouping
