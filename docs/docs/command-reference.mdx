...
- `spawn_claude` (Claude spawn: required `cwd`; optional `model`, `effort`, `agent`, `permission_mode`, `settings`, `timeout_ms`, `initial_prompt`, `policy`)
- `spawn_codex` (Codex spawn: required `cwd`; optional `model`, `effort`, `timeout_ms`, `initial_prompt`, `policy`)
- `spawn_agy` (Agy spawn: required `cwd`; optional `timeout_ms`, `initial_prompt`, `policy`)
- `prompt`
- `wait`
- `kill`
- `snapshot`
