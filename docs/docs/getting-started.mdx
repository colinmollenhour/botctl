...
1. Open at least one Claude Code, Codex CLI, OpenCode, or Antigravity pane inside `tmux`.
...
- Antigravity support is passive dashboard and status visibility. YOLO and recovery actions are not supported in v1.
