...
By default, stdout contains only the assistant answer. Pass `--verbose` to write launch/wait progress to stderr. The tmux session remains available for inspection.
