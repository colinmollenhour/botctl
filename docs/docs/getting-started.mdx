...
- `dashboard` for a live control surface across supported agent panes and conservative Claude-only recovery offers after an external tool recreates missing tmux shell panes
