...
2. the pane is confirmed to be Claude-owned for guarded automation, classified as Codex for command permission approval, or passively resolved as OpenCode for dashboard visibility
...
- debounced reconciliation through `capture-pane`
